/**
 * Pinecone client — vector store for mortgage intelligence.
 */
...
export async function getIndexStats(): Promise<{
  totalVectors: number; indexName: string;
  ...
  return { totalVectors: stats.totalRecordCount ?? 0, indexName: process.env.PINECONE_INDEX_NAME || 'mortgage-intelligence', namespaces, indexFullness: stats.indexFullness ?? 0 };
}
